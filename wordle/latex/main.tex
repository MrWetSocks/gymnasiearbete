...
\subsection{Bitvisa operationer}
Eftersom jag konverterar alla ord till tal i mitt arbete så behöver vi ett par operationer som kan användas för att kolla om två ord har gemensamma bokstäver.
...
$\lim_{x \to a} f(x) = f(a) \text{ och } f(a) \text{ är definierat }$\\
